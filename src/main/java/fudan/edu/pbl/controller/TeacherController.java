...
public class TeacherController {
    ...
    @RequestMapping(value = "/teacher/getinfo", method = RequestMethod.GET)
    public TeacherResponse getInfo(HttpSession session){
        ...
        return new TeacherResponse(user.getUserID(),user.getUserName(),user.getSchool(),user.getDepartment(),user.getEmail(),user.getPhone(),user.getImgPath());
    }
